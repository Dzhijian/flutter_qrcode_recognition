package com.yue.flutter.example.qrcode_recognition;
...
/** QrcodeRecognitionPlugin */
public class QrcodeRecognitionPlugin implements FlutterPlugin, MethodCallHandler {
...
//        HINTS.put(DecodeHintType.PURE_BARCODE, Boolean.TRUE);
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "qrcode_recognition");
  ...
  public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "qrcode_recognition");
        channel.setMethodCallHandler(new QrcodeRecognitionPlugin());
  }
